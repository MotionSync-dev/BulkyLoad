  ...
  const fetchGumroadInfo = async () => {
    try {
      const response = await axios.get(
        `${
          import.meta.env.VITE_API_URL || "http://localhost:3001"
        }/api/subscription/gumroad/product`
      );
          ...
          <div className="card mb-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Get unlimited downloads and premium features for just
                $9.99/month
              </p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700">
                      Cancelling your subscription will take effect at the end
                      of your current billing period. You'll continue to have
